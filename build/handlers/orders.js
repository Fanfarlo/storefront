...
var addProducts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, productId, quantity, addedInfo, err_1, verifyAuthToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.addProducts(orderId, productId, quantity)];
            case 2:
                addedInfo = _a.sent();
                res.send(addedInfo);
                return [3 /*break*/, 4];
            case 3:
                ...
                return [3 /*break*/, 4];
            case 4:
                verifyAuthToken = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
