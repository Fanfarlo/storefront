...
var productsTopFivePopular = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.productsTopFivePopular(req.params.top)];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
...
var activeOrderByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.currentOrderByUser(req.params.userId)];
            case 1:
                order = _a.sent();
                // console.log(order);
                res.json(order);
...
var completeOrderByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.completeOrderByUser(req.params.userId)];
            case 1:
                order = _a.sent();
                // console.log(order);
                res.json(order);
