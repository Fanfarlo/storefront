...
describe('Order methods', () => {
    ...
    it('should create an order', async () => {
        ...
        await conn.query("INSERT INTO users (firstname, lastname, password) VALUES ('miguelo', 'malpartida', 'pass') RETURNING *;");
        await conn.query("INSERT INTO products (name, price, category) VALUES ('VivoBook', 2000, 'ASUS') RETURNING *;");
        await request
            .post('/orders')
